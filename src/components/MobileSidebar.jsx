  ...
  return (
    <>
      {window.innerWidth < 1024 && isMenuOpen && (
        <div
          className={`z-50 fixed top-0 bottom-0 left-0  transition-all    ${
            !isMenuOpen
              ? "-translate-x-[400px] ease-in-out duration-5000 "
              : "translate-x-0 ease-in-out  duration-5000"
          } bg-[#0f0f0f] text-[#fff] text-sm min-w-[150px]  font-semibold h-screen  pl-2 pb-5 overflow-y-scroll mb-80`}
        >
          ...
          <ul className="    border-b-1 pb-4 border-gray-700 mb-3 mt-1 ">
            ...
            <li className="flex gap-4 items-center hover:bg-[#2b2a2a] rounded-lg p-2 px-4 hover:cursor-pointer pb-2 mr-5">
              <MdHome size={22} /> Home
            </li>
            </Link>
            <li className="flex gap-4 items-center hover:bg-[#2b2a2a] rounded-lg p-2 px-4 hover:cursor-pointer pb-2 mr-5">
